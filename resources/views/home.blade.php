...
<div class="contact_form">
  <div class="container"> 
    <div class="row">
        ...
        <table class="table table-response">
          ...
          @endif  
             ...
             <a href="" class="btn btn-sm btn-info"> View</a>
               ...
               <td scope="col">
               <a href="{{ url('request/return/'.$row->id) }}" class="btn btn-sm btn-danger" > Return  </a>
               </td>
              </tr>
             @endforeach
      ...
      <div class="col-4">
        <div class="card">
          <img src="{{ asset('public/frontend/images/cv.jpg') }}" class="card-img-top" style="height: 90px; width: 90px; margin-left: 34%;">
          <div class="card-body">
