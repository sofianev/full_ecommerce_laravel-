  ...
  <!-- ########## START: MAIN PANEL ########## -->
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <h6 class="card-body-title">New Prouct Add
            <a href="{{route('all.product')}}" class="btn btn-success btn-sm pull-right">All product </a>
          </h6>
          <p class="mg-b-20 mg-sm-b-30">New Prouct Add Form</p>
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="product_name" placeholder="Enter product_name">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="discount_price" placeholder="dicount product">
                </div>
              </div><!-- col-4 -->
            ...
            <div class="col-lg-4">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="selling_price" value="" placeholder="Enter selling_price">
                </div>
              </div><!-- col-4 -->
