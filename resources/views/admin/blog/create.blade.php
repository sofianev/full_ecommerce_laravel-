      ...
      <div class="sl-pagebody">
          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Post title(FRANCAIS) <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="post_title_fr" placeholder="Enter product code">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="summernote" name="post_detail_en"></textarea>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="summernote1" name="post_detail_fr"></textarea>
