...
<div class="col-lg-5" style="border: 1px solid grey; padding: 20px; border-radius: 25px;"> 
                    <div class="contact_form_container">
                        <div class="contact_form_title text-center">Cart Number</div>
...
var stripe = Stripe('pk_test_51Iue0oIaMk4AiReOZiNszn2KQvqXQdPLIKeDfxSAROcqSBJkrtGyNu8LdnKBwlo8nxUWJrt3x3u8HKpoMs8gyfp2001OZ9UcO7');
