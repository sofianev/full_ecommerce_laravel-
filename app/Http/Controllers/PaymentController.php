...
class PaymentController extends Controller
{
   ...
   \Stripe\Stripe::setApiKey('sk_test_51Iue0oIaMk4AiReOZtBtoaPo4ABxRWjSUhTxxxhRglbL1dbkdwdWlRmU1RojlPm8Va7A5qKxsvAiqHem983WZ6uO00tSjwLV4H');
   ...
   $charge = \Stripe\Charge::create([
       'amount' => $total*100,
       'currency' => 'usd',
       'description' => 'sofiane Ecommerce Details',
       'source' => $token,
